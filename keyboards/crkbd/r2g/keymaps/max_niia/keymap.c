...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          CW_TOGG,        KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,                             KC_N,        KC_M,     KC_COMM,      KC_DOT,     KC_SLSH,RGUI_T(KC_BSLS),
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
  ...
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          KC_TRNS,     KC_QUES,      KC_GRV,     KC_TILD,     KC_LPRN,     KC_RPRN,                          KC_CIRC,     KC_AMPR,     KC_MINUS,    KC_UNDS,   KC_DOLLAR,     KC_TRNS,
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          KC_TRNS,     KC_EXLM,       KC_AT,     KC_HASH,     KC_LCBR,     KC_RCBR,                          KC_PERC,     KC_ASTR,     KC_PLUS,    KC_EQUAL,     KC_TRNS,     KC_TRNS,
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          KC_TRNS,     KC_BSLS,     KC_PIPE,     KC_AMPR,     KC_LBRC,     KC_RBRC,                          KC_LABK,     KC_RABK,     KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            MO(6),  KC_SPC, KC_LALT,     KC_ESC, KC_BSPC,  KC_DEL
                                      //`--------------------------'  `--------------------------'
  ),
  [6] = LAYOUT_split_3x6_3(
  //,--------+--------+--------+--------+--------+--------.                        ,------------+------------+------------+------------+------------+------------.
      KC_TRNS, KC_TRNS,    KC_7,    KC_8,    KC_9, KC_TRNS,                                KC_NO,       KC_F9,      KC_F10,      KC_F11,      KC_F12,     KC_TRNS,
  //|--------+--------+--------+--------+--------+--------|                        |------------+------------+------------+------------+------------+------------|
      KC_TRNS,    KC_0,    KC_4,    KC_5,    KC_6, KC_TRNS,                                KC_NO,       KC_F5,       KC_F6,       KC_F7,       KC_F8,       KC_NO,
  //|--------+--------+--------+--------+--------+--------|                        |------------+------------+------------+------------+------------+------------|
      KC_TRNS, KC_TRNS,    KC_1,    KC_2,    KC_3, KC_TRNS,                                KC_NO,       KC_F1,       KC_F2,       KC_F3,       KC_F4,     KC_TRNS,
  //|--------+--------+--------+--------+--------+--------+--------|  |------------+------------+------------+------------+------------+------------+------------|
                                          KC_TRNS, KC_TRNS, KC_TRNS,        KC_TRNS,     KC_TRNS,LT(3,KC_DEL)
                                      //`--------------------------'  `--------------------------------------'
  )};
